...
<div class="grid grid-cols-1 md:grid-cols-2 gap-12">
	<div class="text-center">
		<div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
			<a href={guild.id + '/settings'} class="bg-gray-100 dark:bg-slate-800 p-4 rounded-xl shadow-sm hover:underline link">
				<i class="fas fa-gears text-4xl mb-4" />
				<p class="font-semibold text-center text-lg">General</p>
			</a>
			<a href={guild.id + '/categories'} class="bg-gray-100 dark:bg-slate-800 p-4 rounded-xl shadow-sm hover:underline link">
				<i class="fas fa-list text-4xl mb-4" />
				<p class="font-semibold text-center text-lg">Categories</p>
			</a>
			<a href={guild.id + '/create-panel'} class="bg-gray-100 dark:bg-slate-800 p-4 rounded-xl shadow-sm hover:underline link">
				<i class="fas fa-sliders text-4xl mb-4" />
				<p class="font-semibold text-center text-lg">Panels</p>
			</a>
			<a href={guild.id + '/feedback'} class="bg-gray-100 dark:bg-slate-800 p-4 rounded-xl shadow-sm hover:underline link">
				<i class="fas fa-comments text-4xl mb-4" />
				<p class="font-semibold text-center text-lg">Feedback</p>
			</a>
			<a href={guild.id + '/tags'} class="bg-gray-100 dark:bg-slate-800 p-4 rounded-xl shadow-sm hover:underline link">
				<i class="fas fa-tags text-4xl mb-4" />
				<p class="font-semibold text-center text-lg">Tags</p>
			</a>
			<a href={guild.id + '/reset'} class="bg-red-300 dark:bg-red-500/20 hover:bg-red-500 dark:hover:bg-red-500 p-4 rounded-xl shadow-sm hover:underline transition duration-300">
